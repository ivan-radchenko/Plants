    ...
    <div class="desktop" wire:key="desktop">
        <div class="section-1">
            <div class="wrapper">
                ...
                <input wire:model="searchInput" wire:keydown.enter="search" enterkeyhint="search" class="search" type="text" name="search" id="search"
    ...
    <div class="mobile" wire:key="mobile">
        <div class="section-1">
            <div class="wrapper">
                ...
                <input wire:model="searchInput" wire:keydown.enter="search" class="search" type="text" enterkeyhint="search" name="search" id="searchMobile"
                       placeholder="Найти растеньку" onfocusout="this.placeholder ='Найти растеньку'" onfocus="this.placeholder =''">
