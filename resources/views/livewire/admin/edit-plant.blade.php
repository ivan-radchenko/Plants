<div>
    <link href="{{ asset('css/admin/edit-plant.css') }}" rel="stylesheet">
    <div class="wrapper">
        ...
        <div class="form-wrapper">
            <form wire:submit="update" class="form" method="post">
                ...
                <div class="form-item">
                    ...
                    @else
                        <img class="img-prev" src="{{\Illuminate\Support\Facades\Storage::disk('public')->url($imageOld)}}" alt="plant-image" id="plant-image">
                    @endif
                ...
                <button class="button" type="submit" onClick="window.scrollTo(0,0);">Сохранить</button>
                <a href="{{route('admin.plants')}}"><button type="button" class="button">Назад</button></a>
            </form>
        </div>
    </div>
</div>
